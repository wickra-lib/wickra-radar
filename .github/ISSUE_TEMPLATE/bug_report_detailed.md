...
- [ ] Rust crate (`wickra-radar-core`)
- [ ] Python (`pip install wickra-radar`)
- [ ] Node.js (`npm install wickra-radar`)
- [ ] WASM
- [ ] C ABI (`bindings/c`)
- [ ] C# (`WickraRadar` on NuGet)
- [ ] Go (`bindings/go`)
- [ ] Java (`org.wickra:wickra-radar` on Maven Central)
- [ ] R (`bindings/r`)
- [ ] CLI (`wickra-radar`)
- [ ] Docs / examples only
...
| Field                | Value                                  |
| -------------------- | -------------------------------------- |
| Wickra Radar version       | `e.g. 0.4.2`                           |

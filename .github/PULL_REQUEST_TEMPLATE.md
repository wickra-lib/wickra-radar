...
- [ ] Signals stay data (a serde `RadarSpec` / `Vec<Signal>`), never Rust closures
- [ ] Binding surface mirrored across languages; golden alerts regenerated if the schema changed

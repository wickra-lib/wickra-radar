...
`wickra-radar` is part of the Wickra project and follows the same lightweight
governance model.
...
has been reviewed. Larger or breaking changes (the `RadarSpec` / signal schema,
...
Releases follow semantic versioning. Pre-1.0, the spec and alert schemas may
